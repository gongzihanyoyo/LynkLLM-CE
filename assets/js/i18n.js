...
(function (global) {
  ...
  const DICT = {
    'zh-CN': {
      ...
      tavilyKeysTitle: '可用参数',
      tavilyKeysDesc: '工具调用时模型可自行设置主题、搜索深度、时间范围、结果条数、域名白/黑名单等参数。',
      ...
      fVoice: '音色（voice）',
      fVoiceHint: '留空则使用服务商的默认音色；点击下方常用音色可快速填入',
      ...
      /* ---- Tavily 手动参数 ---- */
      tabAbout: '关于',
      tavilyManualTitle: '手动指定参数',
      tavilyManualDesc: '填写后将在请求中强制生效，且不再交给模型决定；留空则仍由模型在调用时自行指定。',
      tavilyResetParams: '清空手动配置',
      tavilyParamsCleared: '已清空手动配置',
      tavilyParamForced: '该项已由你手动指定，不会再交给模型',
      tavilyAuto: '交给模型',
      tavilyOn: '开启',
      tavilyOff: '关闭'
    },
    ...
    en: {
      ...
      tavilyKeysTitle: 'Available parameters',
      tavilyKeysDesc: 'During a tool call the model may set topic, search depth, time range, result count, domain allow/deny lists and more.',
      ...
      fVoice: 'Voice',
      fVoiceHint: 'Leave empty to use the provider default; click a preset below to fill it in',
      ...
      tabAbout: 'About',
      tavilyManualTitle: 'Manual parameters',
      tavilyManualDesc: 'Anything you fill in is forced into the request and no longer decided by the model; leave it empty to let the model choose.',
      tavilyResetParams: 'Clear overrides',
      tavilyParamsCleared: 'Overrides cleared',
      tavilyParamForced: 'Set by you manually — not offered to the model',
