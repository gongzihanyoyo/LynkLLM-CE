...
(function (global) {
  ...
  const DICT = {
    'zh-CN': {
      ...
      fModel: '模型',
      fModelHint: '点击右侧按钮可从 /models 查询可用模型；查询结果会列在下方供点选，不会自动填入',
    ...
    en: {
      ...
      fModel: 'Model',
      fModelHint: 'Click the button to query models from /models. Results are listed below for you to pick — nothing is filled in automatically',
